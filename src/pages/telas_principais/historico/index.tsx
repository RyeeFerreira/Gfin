...
type HistoricoScreenNavigation = StackNavigationProp<RootStackParamList, 'Historico'>;
type HistoricoScreenRoute = RouteProp<RootStackParamList, 'Historico'>;

type Props = {
    navigation: HistoricoScreenNavigation;
    route: HistoricoScreenRoute;
};
